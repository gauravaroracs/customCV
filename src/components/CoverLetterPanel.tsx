...
interface CoverLetterSectionProps {
  ...
  cvFontWeight: string;
  initialText?: string;
  /** Fired on user edits so the parent can persist the letter. */
...
export function CoverLetterPanel({ cvFontWeight, initialText = "", onTextChange }: CoverLetterSectionProps) {
